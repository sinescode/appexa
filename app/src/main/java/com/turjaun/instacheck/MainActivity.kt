...
class MainActivity : AppCompatActivity() {
    ...
    /**
     * Fixed convertJsonToExcel:
     * - Uses ByteArrayOutputStream to write the workbook in-memory
     * - Writes the bytes directly to the contentResolver output stream
     * - Ensures workbook is closed and streams are flushed
     * - Proper error handling and UI updates on the main thread
     */
    private fun convertJsonToExcel(uri: Uri) {
        ...
        scope.launch(Dispatchers.IO) {
            try {
                ...
                // Write workbook to a ByteArrayOutputStream first
                ...
                // Now write bytes to the destination URI
                ...
                Log.d("ExcelConversion", "Wrote $writtenBytes bytes to final file")
...
// --- Adapter and data class kept unchanged ---
